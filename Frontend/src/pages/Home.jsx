...
function Home() {
    return <>
        ...
        <div style={{ marginTop: "30vh", marginBottom: "5vh" }} className="text-center">
            ...
            <iframe src="https://calendar.google.com/calendar/embed?src=769cb9a2dfee86c00c27ca226476858675b2fce4ee59ee90af79dbabf78f6b8c%40group.calendar.google.com&ctz=America%2FLos_Angeles" style={{border: 0, height: "100vh"}} width="95%" className="mb-5" title="HKN at UCI Events Calendar"></iframe>
        </div>
    </>;
}
